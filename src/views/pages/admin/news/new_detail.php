                                ...
                                <div class="row">
                                        ...
                                        <form class="row g-3 needs-validation" method="POST" action="" novalidate
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="content1" id="content1" rows="4"
                                                    required><?php echo htmlspecialchars($news['content_1']); ?></textarea>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="content2" id="content2"
                                                    rows="4"><?php echo htmlspecialchars($news['content_2']); ?></textarea>
                                            </div>
                                            ...
                                            <div class="modal-footer d-flex justify-content-start mb-5">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="addNews"
                                                    value="Thêm Tin Tức">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 id="preview-title" class="text-dark"><?php echo htmlspecialchars($news['title']); ?></h4>
                                                <p id="preview-description"><?php echo htmlspecialchars($news['description']); ?></p>
                                                ...
                                                <?php endif; ?>
                                                <p id="preview-content1"><?php echo htmlspecialchars($news['content_1']); ?></p>
                                                <?php if (!empty($news['image_2'])): ?>
                                                    <img id="preview-image2"
                                                        ...
                                                        class="img-fluid mb-2 d-block mx-auto" style="display:block;">
                                                <?php endif; ?>
                                                <p id="preview-content2"><?php echo htmlspecialchars($news['content_2']); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
