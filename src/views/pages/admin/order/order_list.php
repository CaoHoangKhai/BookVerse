...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th scope="col" class="col-4 text-center">Địa chỉ</th>
            <th scope="col" class="col text-center">Trạng thái</th>
            <th scope="col" class="col-2 text-center">Hình thức thanh toán</th>
        ...
        foreach ($data["Orders"] as $orders): ?>
            <tr class="order-row" data-status="<?= $orders["Status_Name"] ?>">
                ...
                <td class="text-start align-middle">
                    ...
                    <strong>Địa chỉ: </strong><?= $orders["User_Location_Address"] ?>
                </td>
                ...
                <td class="text-center align-middle">
                    <div class="d-flex justify-content-center">
                        <a href="<?= APP_PATH ?>/admin/order_detail/<?= $orders["Order_id"]; ?>"
