...
<section class="intro-section">
    <div class="container">
        ...
        <ul class="section-content">
            ...
            <!-- <li><strong>Trao đổi sách miễn phí:</strong>
                Kết nối với những người có nhu cầu đổi sách để có được những cuốn sách bạn yêu thích.
            </li> -->
            <li><strong>Nhà xuất bản và tác giả:</strong>
                Cung cấp nền tảng cho nhà xuất bản và tác giả tiếp cận độc giả.
            </li>
            <li><strong>Đánh giá và bình luận:</strong>
                Người dùng có thể chia sẻ cảm nhận về sách, giúp cộng đồng có thêm thông tin.
            </li>
            <li><strong>Gợi ý sách theo sở thích:</strong>
                Hệ thống thông minh gợi ý sách phù hợp với sở thích của từng người.
            </li>
            <!-- <li><strong>Kết nối cộng đồng yêu sách:</strong>
                Tham gia vào một cộng đồng yêu sách, nơi bạn có thể giao lưu và chia sẻ đam mê.
            </li> -->
        </ul>

        <h2 class="section-title">Cách hoạt động</h2>
        <ol class="section-content">
            <li>Đăng ký tài khoản để bắt đầu mua, bán hoặc trao đổi sách.</li>
            <li>Đăng sách cần bán hoặc trao đổi với hình ảnh và mô tả chi tiết.</li>
            <li>Duyệt danh mục sách phong phú hoặc sử dụng công cụ tìm kiếm.</li>
            <li>Liên hệ trực tiếp với người bán hoặc người trao đổi sách.</li>
        </ol>
