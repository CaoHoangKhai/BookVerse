<div class="container d-flex justify-content-center align-items-start" style="min-height: 8vh;">
    <?php if (empty($data["Cart"])): ?>
        <div class="d-flex flex-column align-items-center">
            <img src="<?= APP_PATH ?>/public/media/photos/cart/ko_co_don_hang_1.png" alt="Giỏ hàng trống"
                style="width:200px;">
        ...
        <div class="row w-100">
                ...
                <div class="table-responsive">
                    <table class="table text-center align-middle">
                        ...
                        foreach ($data["Cart"] as $item):
                            ...
                            // Nếu sách còn hàng thì tính tổng tiền
                            if ($status === 1) {
                            ...
                            <tr data-cart-id="<?= $item['Cart_id'] ?>" class="align-middle">
                                ...
                                <?php if ($status === 1): // Nếu sách còn hàng ?>
                                ...
                                <?php else: // Nếu sách không còn hàng ?>
            ...
            <div class="col-md-3 d-flex flex-column">
                <div class="shadow-sm d-flex flex-column justify-content-between">
                    ...
                    <!-- Nếu giỏ hàng có sản phẩm hợp lệ thì hiển thị nút thanh toán -->
                    <?php if ($totalPrice > 0): ?>
                        <a href="<?= APP_PATH ?>/auth/order"
                            class="btn btn-success text-light link-offset-2 link-underline link-underline-opacity-0">
                            Thanh toán ngay
                        </a>
